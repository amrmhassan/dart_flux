...
void main() {
  ...
  setUpAll(() async {
    Router router = Router()
        .get(Endpoint.test, Processors.doneProcessor)
        .post(Endpoint.test, Processors.doneProcessor)
        .put(Endpoint.test, Processors.doneProcessor)
        .delete(Endpoint.test, Processors.doneProcessor)
        .head(Endpoint.test, Processors.doneProcessor)
        .connect(Endpoint.test, Processors.doneProcessor)
        .options(Endpoint.test, Processors.doneProcessor)
        .trace(Endpoint.test, Processors.doneProcessor)
        .patch(Endpoint.test, Processors.doneProcessor);
    server = Server(
